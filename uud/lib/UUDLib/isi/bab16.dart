...
class bab16 extends StatelessWidget {
  final List<Map<String, dynamic>> data = [
    {
      ...
      'content': [
        ...
        "Putusan diambil dengan persetujuan sekurang-kurangnya 2/3 dari pada jumlah anggota Majelis Permusyawaratan Rakyat yang hadir."
      ],
    },
